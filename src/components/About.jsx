...
function About() {
    return (
      <section
        ...
        <div className="md:pt-32 md:px-28 p-5 md:p-7">
         {/* Section Heading */}
          <h2 className="relative text-lg md:text-2xl font-[650] text-[#2f549f] dark:text-[#9eb9ef] font-mono 
                after:content-[''] after:inline-block after:align-middle after:ml-3 after:h-[2px] after:w-[200px] after:bg-[#3b3c3c] after:dark:bg-[#cccfdb]">
                About Me
          </h2>   
        </div>
