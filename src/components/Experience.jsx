            ...
            content: (
                <div>
                    ...
                    <ul>
                        ...
                        <li className = "before:content-['▸'] before:text-3xl before:mr-2 before:dark:text-[#9eb9ef] dark:text-white indent-[-1.45em] pl-7 md:w-[390px] lg:w-[660px] md:text-md lg:text-lg"> Led cross-functional collaboration with marketing, CRM, and product teams to translate business objectives into data-driven analytical specifications, enabling structured analysis of advertising campaign performance and relevant KPIs.  </li>
                        <li className = "before:content-['▸'] before:text-3xl before:mr-2 before:dark:text-[#9eb9ef] dark:text-white indent-[-1.45em] pl-7 md:w-[390px] lg:w-[660px] md:text-md lg:text-lg"> Resolved platform support tickets within 1-week target deadlines by investigating documentation, troubleshooting data issues, and liaising with engineering and analytics teams to maintain system reliability.  </li>
        ...
        },
        {
            ...
            <div>
                ...
                <ul>
                    ...
                    <li className = "before:content-['▸'] before:text-3xl before:mr-2 before:dark:text-[#9eb9ef] dark:text-white indent-[-1.45em] pl-7 md:w-[390px] lg:w-[660px] md:text-md lg:text-lg"> Optimized ETL pipelines with Pandas and NumPy for data processing and transformation. </li>
                    <li className = "before:content-['▸'] before:text-3xl before:mr-2 before:dark:text-[#9eb9ef] dark:text-white indent-[-1.45em] pl-7 md:w-[390px] lg:w-[660px] md:text-md lg:text-lg"> Defined system-level requirements and standardized test conditions for validating data-matching platforms, adding workflow efficiency and enhancing data literacy.</li>
                    <li className = "before:content-['▸'] before:text-3xl before:mr-2 before:dark:text-[#9eb9ef] dark:text-white indent-[-1.45em] pl-7 md:w-[390px] lg:w-[660px] md:text-md lg:text-lg"> Collaborated with data engineers to communicate technical findings, document requirements and work progress, and coordinate improvements to workflow orchestration.  </li>
        ...
        },
        {
            ...
            content: (
                <div>
                    ...
                    <li className="before:content-['▸'] before:text-3xl before:mr-2 before:dark:text-[#9eb9ef] dark:text-white indent-[-1.45em] pl-7 md:w-[390px] lg:w-[660px] md:text-md lg:text-lg"> Analyzed ticketing and attendance data using Excel to evaluate event performance and refine marketing strategies, improving event turnout.  </li>
                    </ul>
                </div>
            )
        },
